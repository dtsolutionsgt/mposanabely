...
public class LA_Lista2 extends BaseAdapter {
    ...
    public LA_Lista2(Context context, PBase owner, ArrayList<clsClasses.clsLista> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.lv_lista2, null);
