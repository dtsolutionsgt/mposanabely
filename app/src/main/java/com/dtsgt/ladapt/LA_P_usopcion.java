...
public class LA_P_usopcion  extends BaseAdapter {
    ...
    public LA_P_usopcion(Context context, PBase owner, ArrayList<clsClasses.clsP_usopcion> results) {
        items = results;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = l_Inflater.inflate(R.layout.lv_p_usopcion, null);
